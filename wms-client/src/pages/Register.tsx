    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-slate-50 relative overflow-hidden px-4 sm:px-6">
      ...
      <div className="bg-white border border-slate-200/80 p-8 rounded-3xl shadow-xl shadow-slate-100/50 w-full max-w-md relative z-10 animate-fade-in">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-black text-slate-800 tracking-tight">Operator Register</h1>
          <p className="text-xs text-slate-400 font-semibold mt-1">Provision a new WMS operator node</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1.5">Secret Password</label>
            <div className="relative">
        ...
        <p className="text-center mt-6 text-xs font-medium text-slate-500">
          Already got keys to the distributed console?{' '}
