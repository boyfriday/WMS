    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-indigo-600 via-indigo-700 to-violet-800 rounded-3xl shadow-xl shadow-indigo-200/50 p-8 sm:p-10 mb-8 text-white">
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="text-indigo-100/90 text-sm sm:text-base mb-0">
            Monitor and manage your warehouse catalog, real-time stock levels,
            and order pipelines with precision.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex items-center justify-between hover:shadow-md transition-all">
          ...
          <div
            className={`w-12 h-12 rounded-xl flex items-center justify-center ${stats.lowStock > 0 ? "bg-rose-50 text-rose-500 animate-pulse-glow" : "bg-slate-50 text-slate-400"}`}
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          <div>
            ...
            <p className="text-slate-500 text-xs leading-relaxed mb-4">
              Access the interactive checkout desk, configure custom cart
              selections, and post instant distribution orders.
            </p>
          </div>
        ...
        >
          <div>
            ...
            <p className="text-slate-500 text-xs leading-relaxed mb-4">
              Examine live units in stock, edit pricing details, create new
              entries, and restock low catalog items instantly.
            </p>
          </div>
        ...
        >
          <div>
            ...
            <p className="text-slate-500 text-xs leading-relaxed mb-4">
              Add descriptive tags, create grouping hierarchies, and cluster
              products to maintain high order classification metrics.
            </p>
          </div>
